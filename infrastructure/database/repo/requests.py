...
from infrastructure.database.repo.receipts import ReceiptRepo
...
class RequestsRepo:
    ...
    def receipts(self) -> ReceiptRepo:
        """
        The Receipts repository sessions are required to manage user operations.
        """
    ...
    def products(self) -> ProductRepo:
        """
        The Products repository sessions are required to manage user operations.
        """
...
if __name__ == "__main__":
    ...
    async def example_usage(config: Config):
        ...
        """
        engine = create_my_engine(config.db)
